...
public class PlantView {
	...
	Label labelCategory = new Label("WYTWÓRNIE");
	ListView<String> list = new ListView<>();
	ObservableList<String> listString;
	Stage stage;
	DataBase db;
	
	public PlantView(Stage stage, DataBase db) {
		this.stage=stage;
		this.db=db;
		controller = new PlantController(stage, db);
		main();
		setStage();
	}
	...
	private void setButtonSize() {
		buttonView.setPrefSize(Double.MAX_VALUE, Double.MAX_VALUE);
	...
	private void addToPanel() {
		...
		panelVBox.getChildren().addAll(buttonView, buttonAdd, buttonEdit, buttonDelete);
	...
	private void setActions() {
		try {
		buttonView.setOnAction(e-> controller.viewPlantAction(list.getSelectionModel().getSelectedItem().toString()));	
		buttonAdd.setOnAction(e -> controller.addingPlantAction());
		buttonEdit.setOnAction(e -> controller.editingPlantAction(list.getSelectionModel().getSelectedItem().toString())); 
		buttonDelete.setOnAction(e -> controller.deletePlantAction(list.getSelectionModel().getSelectedItem().toString()));
